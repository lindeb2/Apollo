...
function Dashboard({ onOpenProject, onNewProject }) {
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      {/* Footer */}
      <div className="bg-gray-800 border-t border-gray-700 px-6 py-3 text-center text-sm text-gray-500">
        ChoirMaster v1.0.0 • WAV-only exports • No cloud, fully local
      </div>
    </div>
  );
}
